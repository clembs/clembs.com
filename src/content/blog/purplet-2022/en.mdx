...
![The Purplet logomark, composed of a 3D purple file icon on top of a small red robot, with extra yellow sparkles and a reload icon. The logo is surrounded by gears in different shades of purple.](_banner.webp)
...
<figure>
![The simpler 2D icon in shades of purple, on top of a banner with the tagline: Next-gen tools to build modern Discord apps.](_banner-colors.webp)
...
<figure>
![A column of color strips: pure white, a light lavender, a medium purple, a dark purple and black.](_colors.webp)
...
<figure>
![Explaining the Purplet logo: Sparkles, the 3D-fied CRBT logo, the purple file icon and the reload icon](_explanations.webp)
...
<figure>
![Different heading levels: From 1 to 4, followed by a lorem ipsum paragraph.](_headings.webp)
