...
summary: First client work for an anime-themed Discord application, leveraging Kikuri’s brand to design a brand new website.
...
![Colors and fonts used](_branding.webp)
...
![Shot with multiple devices running the Kikuri website](_responsive.webp)
...
![A complete view of the website, desktop mode](_desktop.webp)
